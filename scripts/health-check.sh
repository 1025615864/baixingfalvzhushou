...
SERVICES=(
  ...
  "payment-channel-service:8002:/health"
  "embedding-service:8003:/health"
  "order-service:8004:/health"
  "ai-service:8005:/health"
  "news-service:8006:/health"
  "community-service:8007:/health"
  "legal-service:8008:/health"
  "search-service:8009:/health"
  "recommendation-service:8010:/health"
  "notification-service:8011:/health"
  "points-service:8012:/health"
  "archive-service:8013:/health"
  "knowledge-service:8081:/api/health"
)
