...
@router.post("/reconciliation-check", response_model=AgentResponse)
async def reconciliation_check(req: AgentRequest):
    """对账异常检测"""
    return AgentResponse(result="对账检测完成", suggestions=["查看异常明细"])
